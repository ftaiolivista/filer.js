...
var Filer=new function(){function a(a){if(b=a||null)c=b.root,d=!0}var b=null,c=null,d=!1,e=function(a){0!=a.indexOf("filesystem:")&&(a="/"==a[0]?b.root.toURL()+a.substring(1):0==a.indexOf("./")||0==a.indexOf("../")?"../"==a&&c!=b.root?c.toURL()+"/"+a:c.toURL()+a:c.toURL()+"/"+a);return a},l=function(a,b,c,f){var h=function(a){if(a.code==FileError.NOT_FOUND_ERR){if(f)throw Error('"'+c+'" or "'+f+'" does not exist.');throw Error('"'+c+'" does not exist.');}throw Error("Problem getting Entry for one or more paths.");
};b&&(h=b);b=e(c);if(f){var k=e(f);self.resolveLocalFileSystemURL(b,function(b){self.resolveLocalFileSystemURL(k,function(c){a(b,c)},h)},h)}else self.resolveLocalFileSystemURL(b,a,h)},p=function(a,c,g,f,d,n){if(!b)throw Error("Filesystem has not been initialized.");if(typeof a!=typeof c)throw Error("These method arguments are not supported.");var h=g||null,k=void 0!=n?n:!1;(a.isFile||c.isDirectory)&&c.isDirectory?k?a.moveTo(c,h,f,d):a.copyTo(c,h,f,d):l(function(a,b,c){if(c.isDirectory)k?a.moveTo(c,
h,f,b):a.copyTo(c,h,f,b);else if(a=Error('Oops! "'+c.name+" is not a directory!"),b)b(a);else throw a;},a,c)};a.DEFAULT_FS_SIZE=1048576;a.version="0.4.3";a.prototype={get fs(){return b},get isOpen(){return d},get cwd(){return c}};a.prototype.pathToFilesystemURL=function(a){return e(a)};a.prototype.init=function(a,k,g){if(!self.requestFileSystem)throw new MyFileError({code:FileError.BROWSER_NOT_SUPPORTED,name:"BROWSER_NOT_SUPPORTED"});a=a?a:{};var h=a.size||1048576;this.type=self.TEMPORARY;"persistent"in
a&&a.persistent&&(this.type=self.PERSISTENT);var m=function(a){this.size=h;b=a;c=b.root;d=!0;k&&k(a)};this.type==self.PERSISTENT&&navigator.persistentStorage?navigator.persistentStorage.requestQuota(h,function(a){self.requestFileSystem(this.type,a,m.bind(this),g)}.bind(this),g):self.requestFileSystem(this.type,h,m.bind(this),g)};a.prototype.ls=function(a,k,g){if(!b)throw Error("Filesystem has not been initialized.");var h=function(a){c=a;var b=[],h=c.createReader(),f=function(){h.readEntries(function(a){a.length?
(b=b.concat(Util.toArray(a)),f()):(b.sort(function(a,b){return a.name<b.name?-1:b.name<a.name?1:0}),k(b))},g)};f()};a.isDirectory?h(a):0==a.indexOf("filesystem:")?l(h,g,a):c.getDirectory(a,{},h,g)};a.prototype.mkdir=function(a,k,g,f){if(!b)throw Error("Filesystem has not been initialized.");var h=null!=k?k:!1,d=a.split("/"),e=function(b,c){if("."==c[0]||""==c[0])c=c.slice(1);b.getDirectory(c[0],{create:!0,exclusive:h},function(b){if(b.isDirectory)c.length&&1!=d.length?e(b,c.slice(1)):g&&g(b);else if(b=
Error(a+" is not a directory"),f)f(b);else throw b;},function(b){if(b.code==FileError.INVALID_MODIFICATION_ERR)if(b.message="'"+a+"' already exists",f)f(b);else throw b;})};e(c,d)};a.prototype.open=function(a,c,d){if(!b)throw Error("Filesystem has not been initialized.");a.isFile?a.file(c,d):l(function(a){a.file(c,d)},d,e(a))};a.prototype.create=function(a,d,g,f){if(!b)throw Error("Filesystem has not been initialized.");c.getFile(a,{create:!0,exclusive:null!=d?d:!0},g,function(b){b.code==FileError.INVALID_MODIFICATION_ERR&&
(b.message="'"+a+"' already exists");if(f)f(b);else throw b;})};a.prototype.mv=function(a,b,c,d,e){p.bind(this,a,b,c,d,e,!0)()};a.prototype.rm=function(a,c,d){if(!b)throw Error("Filesystem has not been initialized.");var f=function(a){a.isFile?a.remove(c,d):a.isDirectory&&a.removeRecursively(c,d)};a.isFile||a.isDirectory?f(a):l(f,d,a)};a.prototype.cd=function(a,d,g){if(!b)throw Error("Filesystem has not been initialized.");a.isDirectory?(c=a,d&&d(c)):(a=e(a),l(function(a){if(a.isDirectory)c=a,d&&
d(c);else if(a=Error("Path was not a directory."),g)g(a);else throw a;},g,a))};a.prototype.cp=function(a,b,c,d,e){p.bind(this,a,b,c,d,e)()};a.prototype.write=function(a,d,g,f){if(!b)throw Error("Filesystem has not been initialized.");var e=function(a){a.createWriter(function(b){b.onerror=f;if(d.append)b.onwriteend=function(b){g&&g(a,this)},b.seek(b.length);else{var c=!1;b.onwriteend=function(b){c?g&&g(a,this):(c=!0,this.truncate(this.position))}}d.data.__proto__==ArrayBuffer.prototype&&(d.data=new Uint8Array(d.data));
